...
def run_experiment():
    ...
    for exp in experiment_list:
        args = build_args()
        args.exp_name = f"exp3_{exp['name']}"
        args.run_name = args.exp_name
        args.reward_mode = exp["reward_mode"]
        args.cast_penalty = exp["cast_penalty"]
        args.turn_penalty = exp["turn_penalty"]
