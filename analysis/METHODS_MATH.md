...
전체 방법론은 [`methodology.md`](methodology.md), 구현은 [`osl2d/`](osl2d/), 실행 순서는 [`osl2d/run_all.py`](osl2d/run_all.py) (collect → P1 → P2a → P2b → P2c → P3a → P3b → P4).
...
[`methodology.md`](methodology.md) §6 사전등록 기준상 행동 변화 $< 5\%$ 면 **non-causal** 로 falsifiable 보고.
