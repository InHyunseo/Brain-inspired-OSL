...
def run_experiment():
    experiment_list = [
        {"name": "gru", "rsac_actor_backbone": "gru"},
        {"name": "connectome", "rsac_actor_backbone": "connectome"},
        {"name": "connectome2", "rsac_actor_backbone": "connectome2"},
    ]

    for exp in experiment_list:
        args = build_args()
        args.exp_name = f"exp2_backbone_{exp['name']}"
        args.run_name = args.exp_name
        args.rsac_actor_backbone = exp["rsac_actor_backbone"]
